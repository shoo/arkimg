...
- 暗号化セグメント: 複数
  - タイプ: 4 byte BigEndian
  - データ長: 4 byte BigEndian 符号なし32bit整数
  - データ: N byte

`[SOI] | [Segment 1] | [Segment 2] | ... | [EOI] | [Encrypted Segment 1] | [Encrypted Segment 2] ... ` <br/>
`[Encrypted Segment]`: `[Type: 4 bytes] | [Length: 4 bytes] | [Data: N bytes]`
...
- 暗号化チャンク: 複数
  - チャンクFourCC: 4 byte
  - チャンクサイズ: 4 byte LittleEndian 符号なし32bit整数
  - ペイロード: N byte
